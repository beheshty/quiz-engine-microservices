...
// Seed initial data
await AddScopesAndClientsAsync(openIddictConfig, app);

app.Run();


static async Task AddScopesAndClientsAsync(IConfigurationSection openIddictConfig, WebApplication app)
{
