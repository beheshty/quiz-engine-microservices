...
public class AuthorizationController : Controller
{
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        {
            // If the consent is external (e.g. when federating with another identity provider),
            // redirect the user to the external identity provider and exit the real authorization endpoint.
            ...
            // If the consent is explicit and the user has not authorized the client application yet,
            // return a challenge (-) to display a consent form.
    ...
    private IEnumerable<string> GetDestinations(Claim claim, ClaimsPrincipal principal)
    {
        ...
        // To allow OpenIddict to serialize them, you must assign them a destination.
